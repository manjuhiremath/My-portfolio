  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-black text-gray-900 dark:text-white mb-8 uppercase tracking-tight">
          Privacy Policy
        </h1>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-gray-400">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Privacy Policies</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Third Party Privacy Policies</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Children&apos;s Information</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4">Online Privacy Policy Only</h2>
          <p className="mb-6">
