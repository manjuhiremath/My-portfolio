        ...
        <div className="prose dark:prose-invert max-w-[65ch]">
          ...
          <div className="space-y-16">
            <section className="space-y-6">
              <h2 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight font-display">The Vision</h2>
            ...
            <section className="space-y-6">
              <h2 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight font-display">Strategic Coverage</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section className="space-y-6">
              <h2 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight font-display">Commitment</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed italic border-l-4 border-primary pl-8 py-2 bg-gray-50 dark:bg-gray-800/30 rounded-r-2xl font-medium">
          ...
          <div className="mt-32 pt-12 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center not-prose">
