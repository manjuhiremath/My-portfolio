...
const updates = [
  {
    ...
    content_updates: [
      { 
        ...
        replacement: '<div class="my-8"><img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&q=80&w=800" alt="Global energy trade disruption 2026" class="rounded-xl w-full h-auto shadow-lg" /><p class="text-center text-xs text-gray-700 mt-2">Visual representation of maritime logistics pressure in early 2026.</p></div>' 
      },
      {
        marker: "[INFOGRAPHIC: AI productivity gains vs conflict-driven costs 2026]",
        replacement: '<div class="my-8 bg-gray-50 p-6 rounded-xl border border-gray-200"><h4 class="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wider">Productivity Delta 2026</h4><div class="space-y-4 text-xs"><div class="flex justify-between"><span>AI Optimization (Automation)</span><span class="text-emerald-600 font-bold">+12%</span></div><div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden"><div class="h-full bg-emerald-500 w-[12%] animate-pulse"></div></div><div class="flex justify-between"><span>Energy Cost Spike (Conflict)</span><span class="text-rose-600 font-bold">+15%</span></div><div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden"><div class="h-full bg-rose-500 w-[15%]"></div></div></div></div>'
      }
    ]
  },
  {
    ...
    content_updates: [
      {
        ...
        replacement: '<div class="my-8"><img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=800" alt="Global Cyber Defense Center" class="rounded-xl w-full h-auto shadow-lg" /><p class="text-center text-xs text-gray-700 mt-2">Law enforcement agencies coordinate the LeakBase takedown in early 2026.</p></div>'
      },
      {
        marker: "[IMAGE: illicit crypto transaction volume chart 2024-2026]",
        replacement: '<div class="my-8 bg-gray-900 p-6 rounded-xl text-white"><h4 class="text-sm font-bold mb-4 text-emerald-400">Illicit Crypto Inflow ($bn)</h4><div class="flex items-end gap-2 h-24"><div class="flex-1 bg-white/20 rounded-t h-[40%] relative group"><div class="hidden group-hover:block absolute -top-6 left-1/2 -trangray-x-1/2 text-[10px]">$62bn</div></div><div class="flex-1 bg-white/40 rounded-t h-[60%] relative group"><div class="hidden group-hover:block absolute -top-6 left-1/2 -trangray-x-1/2 text-[10px]">$94bn</div></div><div class="flex-1 bg-emerald-500 rounded-t h-[95%] relative group"><div class="hidden group-hover:block absolute -top-6 left-1/2 -trangray-x-1/2 text-[10px]">$154bn</div></div></div><div class="flex justify-between mt-2 text-[9px] font-bold text-white/50 italic"><span>2024</span><span>2025</span><span>2026 (Est)</span></div></div>'
      }
    ]
  }
];
