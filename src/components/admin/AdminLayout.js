      ...
      <div className="lg:pl-64 transition-all duration-300">
        ...
        <header className="sticky top-0 z-30 h-16 bg-white border-b border-gray-200 flex items-center px-4 lg:px-8">
          ...
          <div className="flex-1 flex items-center justify-between">
            {/* Search placeholder */}
            <div className="hidden sm:flex items-center gap-2 text-sm text-gray-700 ml-2">
            ...
            <div className="flex items-center gap-3 ml-auto">
              {/* Notifications */}
              <button className="p-2 text-gray-700 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer">
