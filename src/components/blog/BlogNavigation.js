  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
      <div className="mx-auto max-w-7xl">
        {/* Top bar with brand */}
        <div className="hidden md:flex items-center justify-between border-b border-slate-100 px-4 lg:px-8 py-2">
        ...
        {isSearchOpen && (
          <div className="border-t border-slate-100 bg-slate-50/80 px-4 py-4 lg:px-8 animate-in slide-in-from-top duration-200">
            <div className="mx-auto max-w-2xl">
              <form onSubmit={handleSearch} className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-slate-200 bg-white pl-12 pr-4 text-sm font-medium outline-none transition-all focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10"
                />
              </form>
            </div>
          </div>
