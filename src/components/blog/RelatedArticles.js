    ...
    <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4 snap-x snap-mandatory">
      {blogs.map((blog) => {
        ...
        return (
          ...
          >
            <div className="bg-white dark:bg-[#1e293b] rounded-2xl border border-[#e5e7eb] dark:border-[#1e293b] overflow-hidden shadow-sm transition-all duration-300 group-hover:shadow-md">
              ...
              <div className="p-4">
                ...
                <h3 className="text-sm font-bold text-[#111827] dark:text-[#e2e8f0] line-clamp-2 mb-3 leading-tight group-hover:text-[#2563eb] dark:group-hover:text-[#3b82f6] transition-colors">
                  {blog.title}
                </h3>
